...
- [x] 🚧 **Real-speech validation pass: RUN 2026-09-23. OVERALL: FAIL** against its own fixed criteria (`docs/real-speech-validation-results.md`; 3 speakers, 36 recordings). P1 (0 confirmed wrong orders) and P6/P7 PASS; P3/P3b (false-hold rate) and P4 (evidence accuracy, clean-room) and P5 (evidence-wait bound, by 18 ms once) FAIL. Not blocking Step 4's completion. **Step 6 is NOT demo-ready per this gate** (D-26) — see the update there for the breakdown
...
- [x] 🚧 **Real-speech validation pass: RUN 2026-09-23, OVERALL FAIL.** 3 speakers, 36 recordings, `docs/real-speech-validation-results.md`. Zero-tolerance criterion (P1: no wrong order ever confirmed) held; false-hold rate, clean-room evidence accuracy, and the evidence-wait bound (once, by 18 ms) did not meet their fixed thresholds. **Step 6 is not demo-ready. Stated plainly in README, DEMO.md and the Lab tab, not softened**
