...
3. **The live repair loop was validated once, automatically:** real agent + real STT, a synthetic customer voice, holds induced by fault injection (`docs/live-repair-validation.md`). It is not a human on a microphone, and the sample is small. **The dashboard mic page has never been driven by a real browser microphone.**
